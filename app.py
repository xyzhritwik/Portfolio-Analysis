...
def main():
    ...
    if not statement:
        print("Statement of Transactions NOT FOUND")
    if not holding:
        print("Holding Statement NOT FOUND")
...
# === CONFIG ===
FILE_PATH = r"/Groww_Portfolio_Report.xlsx"
HOLDING_SHEET = "Holdings"
ISIN_MAPPING_FILE = "/isin_to_ticker_map.csv"
...
if prices.empty:
    print("No price data found. Check tickers or market holiday.")
    exit()
